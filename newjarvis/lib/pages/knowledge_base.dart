              ...
              child: ElevatedButton.icon(
                onPressed: () => showDialog(
                  ...
                  builder: (BuildContext context) {
                    return CreateKnowledgeDialog(onConfirm: knowledgeProvider.addKnowledge);
                  },
                ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      margin: const EdgeInsets.symmetric(
                          vertical: 8.0, horizontal: 4.0), // Tăng khoảng cách giữa các Card
                      ...
                      Container(
                        ...
                        onTap: () {
                          ...
                          unitProvider.loadUnitListOfKnowledge().then((_) {
                            // Đóng loading dialog
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const KnowledgeUnitScreen(),
                              ),
                            );
                          }).catchError((error) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Error loading units: $error'),
                              ),
                            );
                          });
                        },
                                      ...
                                      actions: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            Navigator.of(context).pop();
                                            knowledgeProvider.deleteKnowledge(knowledgeList[index].id);
                                          },
