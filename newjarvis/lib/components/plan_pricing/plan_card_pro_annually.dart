...
class PlanCardProAnnually extends StatefulWidget {
  final String title;
  final String price;
  final List<String> features;
  final String moreQueriesperyear;
  ...
  const PlanCardProAnnually({
    super.key,
    required this.title,
    required this.price,
    required this.features,
    required this.moreQueriesperyear,
  ...
  @override
  State<PlanCardProAnnually> createState() => _PlanCardExpandableState();
}

class _PlanCardExpandableState extends State<PlanCardProAnnually> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8.0),
                  _buildFeature(widget.moreQueriesperyear),
                  const SizedBox(height: 16.0),
                  const Text(
                    "Advanced features",
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0),
